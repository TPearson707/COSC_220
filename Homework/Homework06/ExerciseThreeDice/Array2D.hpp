/*
 * Name: Homework06 Exercise 3 Dice: Array2D.hpp
...
/*
 * Description: Checks to see how many of our trials had equal dice rolls
 * Parameters: None
 * Return Type: int
 */
template <class T>
int Array2D<T>::checkSame() {
